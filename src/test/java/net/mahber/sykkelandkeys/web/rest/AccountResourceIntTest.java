...
import net.mahber.sykkelandkeys.config.Constants;
import net.mahber.sykkelandkeys.SykkelAndKeysApp;
import net.mahber.sykkelandkeys.domain.Authority;
import net.mahber.sykkelandkeys.domain.User;
import net.mahber.sykkelandkeys.repository.AuthorityRepository;
import net.mahber.sykkelandkeys.repository.UserRepository;
import net.mahber.sykkelandkeys.security.AuthoritiesConstants;
import net.mahber.sykkelandkeys.service.MailService;
import net.mahber.sykkelandkeys.service.dto.UserDTO;
import net.mahber.sykkelandkeys.web.rest.errors.ExceptionTranslator;
import net.mahber.sykkelandkeys.web.rest.vm.KeyAndPasswordVM;
import net.mahber.sykkelandkeys.web.rest.vm.ManagedUserVM;
import net.mahber.sykkelandkeys.service.UserService;
