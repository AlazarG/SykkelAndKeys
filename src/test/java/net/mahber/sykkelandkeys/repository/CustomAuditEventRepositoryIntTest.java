...
import net.mahber.sykkelandkeys.config.audit.AuditEventConverter;
import net.mahber.sykkelandkeys.domain.PersistentAuditEvent;
...
import static net.mahber.sykkelandkeys.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
